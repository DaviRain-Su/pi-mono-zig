...
pub const LifecyclePhase = capability_mod.LifecyclePhase;
pub const Capability = capability_mod.Capability;
pub const CANONICAL_CAPABILITIES = capability_mod.CANONICAL_CAPABILITIES;
pub const CapabilityEnforcementBranch = capability_mod.CapabilityEnforcementBranch;
pub const CapabilityDenialDiagnostic = capability_mod.CapabilityDenialDiagnostic;
pub const ResourceLimits = capability_mod.ResourceLimits;

pub const denyFirstUnapprovedCapability = capability_mod.denyFirstUnapprovedCapability;
pub const denyRuntimeCapability = capability_mod.denyRuntimeCapability;
pub const denyRuntimeImport = capability_mod.denyRuntimeImport;
pub const runtimeImportCapability = capability_mod.runtimeImportCapability;
pub const parseCapability = capability_mod.parseCapability;
