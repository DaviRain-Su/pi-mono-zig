...
pub const shared = struct {
    ...
    pub const provider_json_put = @import("shared/provider_json_put.zig");
    pub const provider_stream = @import("shared/provider_stream.zig");
    pub const openai_usage = @import("shared/openai_usage.zig");
...
test {
    ...
    _ = @import("providers/test_sse_harness.zig");
    _ = @import("shared/json_serializer_poc_test.zig");
