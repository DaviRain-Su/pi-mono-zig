...
const cli_test = @import("cli/test_harness.zig");
...
const CliStdin = main.testing.CliStdin;
const VERSION = main.testing.version;
const effectiveToolSelection = bootstrap.effectiveToolSelection;
const prepareCliRuntime = runtime_prep.prepareCliRuntime;
const prepareEffectiveEnvMap = main.testing.prepareEffectiveEnvMap;
const runCli = main.runCli;
const runCliWithInput = main.testing.runCliWithInput;
