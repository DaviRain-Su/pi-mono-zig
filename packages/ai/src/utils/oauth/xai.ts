...
async function getDiscoveryDocument(): Promise<Required<DiscoveryDocument>> {
...
function buildAuthorizeUrl(authorizationEndpoint: string, state: string, nonce: string, challenge: string): string {
