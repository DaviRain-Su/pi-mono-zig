...
import { clampThinkingLevel, cleanupSessionResources, getSupportedThinkingLevels, isContextOverflow, modelsAreEqual, resetApiProviders, validateToolArguments, } from "@earendil-works/pi-ai";
...
export class AgentSession {
    ...
    _buildRuntime(options) {
        ...
        this._extensionRunner = new ExtensionRunner(extensionsResult.extensions, extensionsResult.runtime, this._cwd, this.sessionManager, this._modelRegistry, this._resourceLoader.getWasmExtensions());
