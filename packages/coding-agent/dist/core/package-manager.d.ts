import { type ExtensionPolicy, type WasmExtensionIdentity } from "./extension-policy.js";
import { type ExtensionProvenanceDiagnostic } from "./extension-provenance-lockfile.js";
import type { SettingsManager } from "./settings-manager.js";
import { type SourceProvenanceBinding } from "./source-info.js";
...
export declare class DefaultPackageManager implements PackageManager {
    ...
    getInstalledPath(source: string, scope: "user" | "project"): string | undefined;
    private getProvenanceLockfilePath;
    private getSettingsPath;
    private getSettingsScope;
    private captureFileSnapshot;
    private restoreFileSnapshot;
    private restoreFileSnapshots;
    private flushSettingsOrThrow;
    private restorePackageSettingsInMemory;
    private restorePackageSettingsAfterFailedTransaction;
