...
import { attachDiagnosticEnvelope, attachResourceDiagnosticEnvelope, createDiagnosticEnvelope, } from "./diagnostics.js";
...
export class DefaultResourceLoader {
    ...
    async reload() {
        this.extensionsResult.runtime.invalidate("This extension runtime is stale after extension reload, disable, or removal.");
        ...
        const extensionsResult = await loadExtensions(extensionPaths, this.cwd, this.eventBus, {
            resolveSourceInfo: ({ configuredPath, resolvedPath }) => this.findSourceInfoForPath(resolvedPath, undefined, metadataByPath) ??
    ...
    async loadExtensionFactories(runtime) {
        ...
        for (const [index, factory] of this.extensionFactories.entries()) {
            ...
            try {
                ...
                const extension = await loadExtensionFromFactory(factory, this.cwd, this.eventBus, runtime, extensionPath, this.settingsManager.getExtensionPolicy(identity.key));
