...
export declare class ExtensionRunner {
    ...
    private registeredProviderNames;
    constructor(extensions: Extension[], runtime: ExtensionRuntime, cwd: string, sessionManager: SessionManager, modelRegistry: ModelRegistry, wasmExtensions?: ResolvedWasmExtensionPackage[], options?: ExtensionRunnerOptions);
    bindCore(actions: ExtensionActions, contextActions: ExtensionContextActions, providerActions?: ProviderActions): void;
    private registerOwnedProvider;
    private unregisterOwnedProvider;
    private cleanupOwnedProviders;
    ...
    private eventWithHandlerSignal;
    private invokeHandler;
    private invalidSubscriberResult;
    private validateSessionBeforeResult;
    private validateResourcesDiscoverResult;
    private validateInputResult;
    private validateToolResultPatch;
    private validateToolCallResult;
    private validateMessageEndResult;
    private validateContextResult;
    private validateBeforeAgentStartResult;
    private validateUserBashResult;
    private metadataForExtension;
    private isPathInsideBase;
