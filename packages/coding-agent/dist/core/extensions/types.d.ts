 ...
 */
export declare const DEFAULT_EXTENSION_HANDLER_TIMEOUT_MS = 5000;
...
export type ExtensionEvent = ResourcesDiscoverEvent | SessionEvent | ContextEvent | BeforeProviderRequestEvent | AfterProviderResponseEvent | BeforeAgentStartEvent | AgentStartEvent | AgentEndEvent | SubAgentReadinessEvent | TurnStartEvent | TurnEndEvent | MessageStartEvent | MessageUpdateEvent | MessageEndEvent | ToolExecutionStartEvent | ToolExecutionUpdateEvent | ToolExecutionEndEvent | ModelSelectEvent | ThinkingLevelSelectEvent | UserBashEvent | InputEvent | ToolCallEvent | ToolResultEvent;
export declare const EXTENSION_EVENT_NAMES: readonly ["resources_discover", "session_start", "session_before_switch", "session_before_fork", "session_before_compact", "session_compact", "session_shutdown", "session_before_tree", "session_tree", "before_agent_start", "agent_start", "agent_end", "sub_agent_readiness", "turn_start", "turn_end", "message_start", "message_update", "message_end", "tool_execution_start", "tool_execution_update", "tool_execution_end", "tool_call", "tool_result", "user_bash", "context", "before_provider_request", "after_provider_response", "model_select", "thinking_level_select", "input"];
export type ExtensionEventName = (typeof EXTENSION_EVENT_NAMES)[number];
export declare function isExtensionEventName(event: string): event is ExtensionEventName;
export declare const EXTENSION_LIFECYCLE_SUPPORT_MATRIX: {
    readonly typescript: {
        readonly events: readonly ["resources_discover", "session_start", "session_before_switch", "session_before_fork", "session_before_compact", "session_compact", "session_shutdown", "session_before_tree", "session_tree", "before_agent_start", "agent_start", "agent_end", "sub_agent_readiness", "turn_start", "turn_end", "message_start", "message_update", "message_end", "tool_execution_start", "tool_execution_update", "tool_execution_end", "tool_call", "tool_result", "user_bash", "context", "before_provider_request", "after_provider_response", "model_select", "thinking_level_select", "input"];
        readonly payloadFields: {
            readonly session_start: readonly ["type", "reason", "previousSessionFile", "signal"];
            readonly session_shutdown: readonly ["type", "reason", "targetSessionFile", "signal"];
            readonly resources_discover: readonly ["type", "cwd", "reason", "signal"];
            readonly session_before_switch: readonly ["type", "reason", "targetSessionFile", "signal"];
            readonly session_before_fork: readonly ["type", "entryId", "position", "signal"];
        };
        readonly reasons: readonly ["startup", "reload", "new", "resume", "fork"];
        readonly results: readonly ["none", "cancellable", "resources"];
        readonly timeout: {
            readonly source: "ExtensionRunnerOptions.handlerTimeoutMs";
            readonly defaultMs: 5000;
            readonly override: "per-runner";
            readonly abortSignal: true;
            readonly lateResults: "ignored";
        };
        readonly shutdown: {
            readonly supported: true;
            readonly timeout: "same-handler-timeout";
            readonly exactlyOnce: true;
        };
        readonly unsupportedDiagnostics: true;
    };
    readonly process_jsonl: {
        readonly events: readonly ["resources_discover", "session_start", "session_before_switch", "session_before_fork", "session_before_compact", "session_compact", "session_shutdown", "session_before_tree", "session_tree", "before_agent_start", "agent_start", "agent_end", "sub_agent_readiness", "turn_start", "turn_end", "message_start", "message_update", "message_end", "tool_execution_start", "tool_execution_update", "tool_execution_end", "tool_call", "tool_result", "user_bash", "context", "before_provider_request", "after_provider_response", "model_select", "thinking_level_select", "input"];
        readonly payloadFields: {
            readonly session_start: readonly ["type", "reason", "previousSessionFile"];
            readonly session_shutdown: readonly ["type", "reason", "targetSessionFile"];
            readonly resources_discover: readonly ["type", "cwd", "reason"];
        };
        readonly reasons: readonly ["startup", "reload", "new", "resume", "fork"];
        readonly results: readonly ["none", "cancellable", "resources"];
        readonly timeout: {
            readonly source: "lifecycle-handler-timeout-ms";
            readonly defaultMs: 5000;
            readonly override: "runtime-host";
            readonly abortSignal: false;
            readonly lateResults: "ignored";
        };
        readonly shutdown: {
            readonly supported: true;
            readonly timeout: "runtime-shutdown-timeout";
            readonly exactlyOnce: true;
        };
        readonly unsupportedDiagnostics: true;
    };
    readonly wasm: {
        readonly events: readonly ["session_start", "session_shutdown", "resources_discover"];
        readonly payloadFields: {
            readonly session_start: readonly ["type", "reason", "previousSessionFile"];
            readonly session_shutdown: readonly ["type", "reason", "targetSessionFile"];
            readonly resources_discover: readonly ["type", "cwd", "reason"];
        ...
        readonly reasons: readonly ["startup", "reload", "new", "resume", "fork"];
        readonly results: readonly ["none", "resources"];
        readonly timeout: {
            readonly source: "lifecycle-handler-timeout-ms";
            readonly defaultMs: 5000;
            readonly override: "runtime-host";
        ...
        readonly unsupportedDiagnostics: false;
    };
    readonly native: {
        readonly events: readonly ["session_start", "session_shutdown", "resources_discover"];
        readonly payloadFields: {
